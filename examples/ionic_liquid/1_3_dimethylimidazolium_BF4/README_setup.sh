...
cd packmol_files
  ...
  packmol < mixture.inp
  mv -f mixture.pdb ../moltemplate_files/
...
cd moltemplate_files
  ...
  #moltemplate.sh -pdb mixture.pdb system.lt

  # Optional:
  # To check for missing angle,dihedral params run moltemplate this way instead:
  moltemplate.sh -pdb mixture.pdb -overlay-bonds -overlay-angles -overlay-dihedrals -overlay-impropers system.lt 
